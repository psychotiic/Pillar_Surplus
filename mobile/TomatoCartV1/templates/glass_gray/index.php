...
<div id="pageWrapper">
  ...
  <style type="text/css">
	  ...
	  <div class="boxNew">
  <div id="searchBox" class="boxTitle"><?php echo "Search Inventory"; ?><input style="float:right" type="image" src="templates/glass_gray/images/button_quick_find.png" alt="Search" title="Search" id="quickSearch"/></div>
...
?>
  ...
  <div id="pageFooter">
    <ul class="pvw-title">
      <br/>
	  <input style="align:center" type="image" src="templates/glass_gray/images/logofooter.jpg" alt="logof" title="footerLogo" id="logofooter"/><br/><br/>
	  <br/>
	  <?php
        echo '<li>' . osc_link_object(osc_href_link(FILENAME_DEFAULT, 'index'), $osC_Language->get('home')) . '<span>|</span></li>' .
             ...
             '<li >' . osc_link_object(osc_href_link(FILENAME_DEFAULT, 'rss'), '<span >Terms & Conditions</span>') .'</li><br/>';
			 echo"Email: pillar@pillarmfg.com<br/>";
			 echo"line break<br/>";
			 echo"line break<br/>";
			 echo"line break<br/>";	
      ?>
