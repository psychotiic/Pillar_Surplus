      ...
      if ($Qnewproducts->numberOfRows()) {
        ...
        while ($Qnewproducts->next()) {
          ...
          $this->_content .= '<div style="margin-top: 10px; float:left; width: 33%; text-align: center">' .
                             ...
                             osc_link_object(osc_href_link(FILENAME_PRODUCTS, $Qnewproducts->value('products_id')),"<br/>". $osC_Image->show($Qnewproducts->value('image'), $Qnewproducts->value('products_name')), 'id="img_ac_newproductsmodule_' . $Qnewproducts->value('products_id') . '"') .
